      ...
      <div className="flex flex-col gap-y-2 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex flex-col gap-y-2 sm:flex-row sm:items-center sm:space-x-6">
          ...
          <div className="relative w-full max-w-xs sm:max-w-md">
            ...
            <Input
              placeholder="Search"
              className="pl-10 w-full bg-gray-50 dark:bg-gray-950 border-gray-200 dark:border-gray-800"
            />
          </div>
        </div>
        ...
        <div className="flex items-center space-x-2 sm:space-x-4">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="hidden md:block">
              ...
              <p className="text-xs text-gray-500 dark:text-gray-400">{isGuest ? "Not signed in" : "Patient"}</p>
            </div>
          </div>
          <LogoutButton />
        </div>
